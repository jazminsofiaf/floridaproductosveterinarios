        ...
        if (productsInfo) {
            ...
            const newData = productsInfo ? productsInfo.products_info.map((productInfoData: any) => {
                    return {
                        ...
                        vetPrice: calculateValue(productInfoData.cost, productInfoData.extra, margins?.vet ),
                        protecPrice: calculateValue(productInfoData.cost, productInfoData.extra, margins?.pro ),
                        indPrice: calculateValue(productInfoData.cost, productInfoData.extra, margins?.ind ),
                        otherPrice: calculateValue(productInfoData.cost, productInfoData.extra, margins?.oth ),
